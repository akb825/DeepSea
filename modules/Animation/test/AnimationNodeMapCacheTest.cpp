...
TEST(AnimationNodeMapCacheTest, AddRemove)
{
	...
	{
		"foo", dsAnimationComponent_Translation, {{0, 0, 0, 0}}, {{0, 0, 0, 0}}
	};
	...
	ASSERT_TRUE(dsAnimation_addDirectAnimation(animation0, direct2, 1.0f, 1.0f));
	ASSERT_TRUE(dsAnimation_addDirectAnimation(animation1, direct0, 1.0f, 1.0f));
	ASSERT_TRUE(dsAnimation_addKeyframeAnimation(
		animation0, keyframe2, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f, false));
	ASSERT_TRUE(dsAnimation_addKeyframeAnimation(
		animation1, keyframe0, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f, false));
	...
	ASSERT_TRUE(dsAnimation_addDirectAnimation(animation0, direct1, 1.0f, 1.0f));
	ASSERT_TRUE(dsAnimation_addDirectAnimation(animation1, direct1, 1.0f, 1.0f));
	ASSERT_TRUE(dsAnimation_addKeyframeAnimation(
		animation0, keyframe1, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f, false));
	ASSERT_TRUE(dsAnimation_addKeyframeAnimation(
		animation1, keyframe1, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f, false));

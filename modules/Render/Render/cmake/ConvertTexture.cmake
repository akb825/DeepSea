...
if (CUTTLEFISH_LOCAL)
	set(CUTTLEFISH ${CUTTLEFISH_LOCAL} CACHE FILEPATH "cuttlefish texture converter tool")
else()
	find_program(CUTTLEFISH_SYSTEM cuttlefish NO_CMAKE_FIND_ROOT_PATH)
	if (CUTTLEFISH_SYSTEM)
		set(CUTTLEFISH ${CUTTLEFISH_SYSTEM} CACHE FILEPATH "cuttlefish texture converter tool")
	else()

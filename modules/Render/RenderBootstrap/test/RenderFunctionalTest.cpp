...
private:
	void initialize(const FixtureBase& fixture)
	{
		...
		dsTextureInfo offscreenInfo = {surfaceFormat, dsTextureDim_2D, 2, 2, 0, 1, 1};
		offscreen = dsTexture_createOffscreen(resourceManager, allocator,

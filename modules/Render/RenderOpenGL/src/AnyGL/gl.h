...
#define ANYGL_EXT_mesh_shader 1
#endif
ANYGL_EXPORT extern int AnyGL_EXT_mesh_shader;
...
#define ANYGL_EXT_shader_texture_samples 1
#endif
ANYGL_EXPORT extern int AnyGL_EXT_shader_texture_samples;
...
/* GL_EXT_mesh_shader */
typedef void (APIENTRY* PFNANYGLDRAWMESHTASKSEXTPROC)(GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z);
typedef void (APIENTRY* PFNANYGLDRAWMESHTASKSINDIRECTEXTPROC)(GLintptr indirect);
typedef void (APIENTRY* PFNANYGLMULTIDRAWMESHTASKSINDIRECTEXTPROC)(GLintptr indirect, GLsizei drawcount, GLsizei stride);
typedef void (APIENTRY* PFNANYGLMULTIDRAWMESHTASKSINDIRECTCOUNTEXTPROC)(GLintptr indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);

ANYGL_EXPORT extern PFNANYGLDRAWMESHTASKSEXTPROC AnyGL_glDrawMeshTasksEXT;
ANYGL_EXPORT extern PFNANYGLDRAWMESHTASKSINDIRECTEXTPROC AnyGL_glDrawMeshTasksIndirectEXT;
ANYGL_EXPORT extern PFNANYGLMULTIDRAWMESHTASKSINDIRECTEXTPROC AnyGL_glMultiDrawMeshTasksIndirectEXT;
ANYGL_EXPORT extern PFNANYGLMULTIDRAWMESHTASKSINDIRECTCOUNTEXTPROC AnyGL_glMultiDrawMeshTasksIndirectCountEXT;

#ifndef ANYGL_NO_DEFINES
#define glDrawMeshTasksEXT(num_groups_x, num_groups_y, num_groups_z) ANYGL_CALL(AnyGL_glDrawMeshTasksEXT)(num_groups_x, num_groups_y, num_groups_z)
#define glDrawMeshTasksIndirectEXT(indirect) ANYGL_CALL(AnyGL_glDrawMeshTasksIndirectEXT)(indirect)
#define glMultiDrawMeshTasksIndirectEXT(indirect, drawcount, stride) ANYGL_CALL(AnyGL_glMultiDrawMeshTasksIndirectEXT)(indirect, drawcount, stride)
#define glMultiDrawMeshTasksIndirectCountEXT(indirect, drawcount, maxdrawcount, stride) ANYGL_CALL(AnyGL_glMultiDrawMeshTasksIndirectCountEXT)(indirect, drawcount, maxdrawcount, stride)
#endif /* ANYGL_NO_DEFINES */

...
inline bool VerifyRigidBodyNodeBuffer(
  ...
  return verifier.template VerifyBuffer<DeepSeaScenePhysics::RigidBodyNode>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedRigidBodyNodeBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<DeepSeaScenePhysics::RigidBodyNode>(nullptr);
}

...
#ifndef FLATBUFFERS_GENERATED_VECTORITEMLIST_DEEPSEAVECTORDRAWSCENE_H_
#define FLATBUFFERS_GENERATED_VECTORITEMLIST_DEEPSEAVECTORDRAWSCENE_H_
...
inline flatbuffers::Offset<VectorItemList> CreateVectorItemListDirect(
  ...
  return DeepSeaVectorDrawScene::CreateVectorItemList(
      _fbb,
      instanceData__,
      dynamicRenderStates);
}

inline const DeepSeaVectorDrawScene::VectorItemList *GetVectorItemList(const void *buf) {
  return flatbuffers::GetRoot<DeepSeaVectorDrawScene::VectorItemList>(buf);
}

inline const DeepSeaVectorDrawScene::VectorItemList *GetSizePrefixedVectorItemList(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<DeepSeaVectorDrawScene::VectorItemList>(buf);
}

inline bool VerifyVectorItemListBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DeepSeaVectorDrawScene::VectorItemList>(nullptr);
}

inline bool VerifySizePrefixedVectorItemListBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DeepSeaVectorDrawScene::VectorItemList>(nullptr);
}

inline void FinishVectorItemListBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<DeepSeaVectorDrawScene::VectorItemList> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_VECTORITEMLIST_DEEPSEAVECTORDRAWSCENE_H_

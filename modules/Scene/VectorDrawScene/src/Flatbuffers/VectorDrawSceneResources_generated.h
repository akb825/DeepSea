...
#ifndef FLATBUFFERS_GENERATED_VECTORDRAWSCENERESOURCES_DEEPSEAVECTORDRAWSCENE_H_
#define FLATBUFFERS_GENERATED_VECTORDRAWSCENERESOURCES_DEEPSEAVECTORDRAWSCENE_H_
...
inline const DeepSeaVectorDrawScene::VectorResources *GetVectorResources(const void *buf) {
  return flatbuffers::GetRoot<DeepSeaVectorDrawScene::VectorResources>(buf);
}

inline const DeepSeaVectorDrawScene::VectorResources *GetSizePrefixedVectorResources(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<DeepSeaVectorDrawScene::VectorResources>(buf);
}

inline bool VerifyVectorResourcesBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DeepSeaVectorDrawScene::VectorResources>(nullptr);
}

inline bool VerifySizePrefixedVectorResourcesBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DeepSeaVectorDrawScene::VectorResources>(nullptr);
}

inline void FinishVectorResourcesBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<DeepSeaVectorDrawScene::VectorResources> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_VECTORDRAWSCENERESOURCES_DEEPSEAVECTORDRAWSCENE_H_

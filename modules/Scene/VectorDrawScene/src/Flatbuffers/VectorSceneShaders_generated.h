...
#ifndef FLATBUFFERS_GENERATED_VECTORSCENESHADERS_DEEPSEAVECTORDRAWSCENE_H_
#define FLATBUFFERS_GENERATED_VECTORSCENESHADERS_DEEPSEAVECTORDRAWSCENE_H_
...
inline const DeepSeaVectorDrawScene::VectorShaders *GetVectorShaders(const void *buf) {
  return flatbuffers::GetRoot<DeepSeaVectorDrawScene::VectorShaders>(buf);
}

inline const DeepSeaVectorDrawScene::VectorShaders *GetSizePrefixedVectorShaders(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<DeepSeaVectorDrawScene::VectorShaders>(buf);
}

inline bool VerifyVectorShadersBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DeepSeaVectorDrawScene::VectorShaders>(nullptr);
}

inline bool VerifySizePrefixedVectorShadersBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DeepSeaVectorDrawScene::VectorShaders>(nullptr);
}

inline void FinishVectorShadersBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<DeepSeaVectorDrawScene::VectorShaders> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_VECTORSCENESHADERS_DEEPSEAVECTORDRAWSCENE_H_

...
inline bool VerifyAnimationTreeNodeBuffer(
  ...
  return verifier.template VerifyBuffer<DeepSeaSceneAnimation::AnimationTreeNode>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedAnimationTreeNodeBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<DeepSeaSceneAnimation::AnimationTreeNode>(nullptr);
}

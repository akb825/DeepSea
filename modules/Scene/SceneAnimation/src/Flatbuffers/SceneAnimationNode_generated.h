...
#ifndef FLATBUFFERS_GENERATED_SCENEANIMATIONNODE_DEEPSEASCENEANIMATION_H_
#define FLATBUFFERS_GENERATED_SCENEANIMATIONNODE_DEEPSEASCENEANIMATION_H_
...
inline bool VerifyAnimationNodeBuffer(
  ...
  return verifier.template VerifyBuffer<DeepSeaSceneAnimation::AnimationNode>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedAnimationNodeBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<DeepSeaSceneAnimation::AnimationNode>(nullptr);
}
...
#endif  // FLATBUFFERS_GENERATED_SCENEANIMATIONNODE_DEEPSEASCENEANIMATION_H_

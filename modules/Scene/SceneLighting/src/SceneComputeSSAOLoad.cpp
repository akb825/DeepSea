...
extern "C"
dsSceneItemList* dsSceneComputeSSAO_load(const dsSceneLoadContext* loadContext,
	...
	void*, const char* name, const uint8_t* data, size_t dataSize)
{
	...
	{
		errno = EFORMAT;
		DS_LOG_ERROR(DS_SCENE_LIGHTING_LOG_TAG, "Invalid scene compute SSAO flatbuffer format.");
		return nullptr;
	}
	...
	return (dsSceneItemList*)dsSceneComputeSSAO_create(allocator, resourceManager,
		resourceAllocator, name, shader, material);
}

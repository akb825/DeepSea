 ...
 */
DS_SCENEVECTORDRAW_EXPORT extern const char* const dsSceneVectorResources_typeName;

/**
 * @brief Gets the type for the dsVectorResources custom type for storage in dsSceneResources.
 * @return The custom type.
 */
DS_SCENEVECTORDRAW_EXPORT const dsCustomSceneResourceType* dsSceneVectorResources_type(void);
 ...
 * @param resources The vector resources to wrap. This will take ownership of the vector resources
 *     and destroy it if creation fails.
 * @return The custom resource or NULL if an error occurred.
 */
DS_SCENEVECTORDRAW_EXPORT dsCustomSceneResource* dsSceneVectorResources_create(

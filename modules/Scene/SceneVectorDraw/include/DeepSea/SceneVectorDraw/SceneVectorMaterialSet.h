 ...
 */
DS_SCENEVECTORDRAW_EXPORT extern const char* const dsSceneVectorMaterialSet_typeName;

/**
 * @brief Gets the type for the dsVectorMaterialSet custom type for storage in dsSceneResources.
 * @return The custom type.
 */
DS_SCENEVECTORDRAW_EXPORT const dsCustomSceneResourceType* dsSceneVectorMaterialSet_type(void);

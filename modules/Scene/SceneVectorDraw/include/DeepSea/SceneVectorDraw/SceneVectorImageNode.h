 ...
 */
DS_SCENEVECTORDRAW_EXPORT extern const char* const dsSceneVectorImageNode_typeName;

/**
 * @brief Gets the type of a vector image node.
 * @return The type of a vector image node.
 */
DS_SCENEVECTORDRAW_EXPORT const dsSceneNodeType* dsSceneVectorImageNode_type(void);
 ...
 */
DS_SCENEVECTORDRAW_EXPORT const dsSceneNodeType* dsSceneVectorImageNode_setupParentType(

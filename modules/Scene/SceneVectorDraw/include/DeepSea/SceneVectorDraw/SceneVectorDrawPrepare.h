...
/**
 * @file
 * @brief Functions for creating and manipulating scene vector draw prepares.
 *
 ...
 */
DS_SCENEVECTORDRAW_EXPORT extern const char* const dsSceneVectorDrawPrepare_typeName;

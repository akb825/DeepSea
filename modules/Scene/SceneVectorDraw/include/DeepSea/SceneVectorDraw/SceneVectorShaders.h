 ...
 */
DS_SCENEVECTORDRAW_EXPORT extern const char* const dsSceneVectorShaders_typeName;

/**
 * @brief Gets the type for the dsVectorShaders custom type for storage in dsSceneResources.
 * @return The custom type.
 */
DS_SCENEVECTORDRAW_EXPORT const dsCustomSceneResourceType* dsSceneVectorShaders_type(void);

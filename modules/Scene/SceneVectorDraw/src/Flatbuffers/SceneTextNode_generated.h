...
#ifndef FLATBUFFERS_GENERATED_SCENETEXTNODE_DEEPSEASCENEVECTORDRAW_H_
#define FLATBUFFERS_GENERATED_SCENETEXTNODE_DEEPSEASCENEVECTORDRAW_H_
...
inline bool VerifyTextNodeBuffer(
  ...
  return verifier.template VerifyBuffer<DeepSeaSceneVectorDraw::TextNode>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedTextNodeBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<DeepSeaSceneVectorDraw::TextNode>(nullptr);
}
...
#endif  // FLATBUFFERS_GENERATED_SCENETEXTNODE_DEEPSEASCENEVECTORDRAW_H_

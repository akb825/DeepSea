...
#ifndef FLATBUFFERS_GENERATED_SCENEVECTORIMAGENODE_DEEPSEASCENEVECTORDRAW_H_
#define FLATBUFFERS_GENERATED_SCENEVECTORIMAGENODE_DEEPSEASCENEVECTORDRAW_H_
...
inline bool VerifyVectorImageNodeBuffer(
  ...
  return verifier.template VerifyBuffer<DeepSeaSceneVectorDraw::VectorImageNode>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedVectorImageNodeBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<DeepSeaSceneVectorDraw::VectorImageNode>(nullptr);
}
...
#endif  // FLATBUFFERS_GENERATED_SCENEVECTORIMAGENODE_DEEPSEASCENEVECTORDRAW_H_

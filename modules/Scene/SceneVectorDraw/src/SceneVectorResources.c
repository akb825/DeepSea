...
const char* const dsSceneVectorResources_typeName = "VectorResources";

static dsCustomSceneResourceType resourceType;
const dsCustomSceneResourceType* dsSceneVectorResources_type(void)
{
	return &resourceType;
}

dsCustomSceneResource* dsSceneVectorResources_create(dsAllocator* allocator,

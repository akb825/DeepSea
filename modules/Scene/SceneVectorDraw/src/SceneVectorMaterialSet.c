...
const char* const dsSceneVectorMaterialSet_typeName = "VectorMaterialSet";

static dsCustomSceneResourceType resourceType;
const dsCustomSceneResourceType* dsSceneVectorMaterialSet_type(void)
{
	return &resourceType;
}

dsCustomSceneResource* dsSceneVectorMaterialSet_create(dsAllocator* allocator,

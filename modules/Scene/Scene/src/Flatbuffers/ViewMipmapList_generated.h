...
inline bool VerifyViewMipmapListBuffer(
  ...
  return verifier.template VerifyBuffer<DeepSeaScene::ViewMipmapList>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedViewMipmapListBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<DeepSeaScene::ViewMipmapList>(nullptr);
}

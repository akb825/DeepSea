...
inline bool VerifyFullScreenResolveBuffer(
  ...
  return verifier.template VerifyBuffer<DeepSeaScene::FullScreenResolve>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedFullScreenResolveBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<DeepSeaScene::FullScreenResolve>(nullptr);
}

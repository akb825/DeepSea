...
/**
 * @file
 * @brief Functions for creating dsSceneInstanceData instances that manage screen-space instance
 * transforms.
 *
 * This populates the uniforms found in DeepSea/Scene/Shaders/InstanceScreenTransform.mslh
 *
 * @see dsSceneInstanceData
 */

/**
 * @brief The instance screen transform data type name.
 */
DS_SCENE_EXPORT extern const char* const dsInstanceScreenTransformData_typeName;

/**
 * @brief The instance screen transform data shader uniform name.
 */
DS_SCENE_EXPORT extern const char* const dsInstanceScreenTransformData_uniformName;
 ...
 */
DS_SCENE_EXPORT dsShaderVariableGroupDesc*
dsInstanceScreenTransformData_createShaderVariableGroupDesc(
	dsResourceManager* resourceManager, dsAllocator* allocator);

/**
 * @brief Checks whether or not a shader variable group is compatible with
 *     dsInstanceScreenTransformData.
 * @param transformDesc The shader variable group for the transform.
 * @return Whether or not transformDesc is compatible.
 */
DS_SCENE_EXPORT bool dsInstanceScreenTransformData_isShaderVariableGroupCompatible(
	const dsShaderVariableGroupDesc* transformDesc);

/**
 * @brief Creates instance screen trnasform data to use with a dsSceneItemList.
 ...
 */
DS_SCENE_EXPORT dsSceneInstanceData* dsInstanceScreenTransformData_create(dsAllocator* allocator,

 ...
 */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3f_makeInvalid(dsAlignedBox3f* result);

/** @copydoc dsAlignedBox3f_makeInvalid() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3d_makeInvalid(dsAlignedBox3d* result);

/** @copydoc dsAlignedBox3f_makeInvalid() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3i_makeInvalid(dsAlignedBox3i* result);
...
DS_GEOMETRY_EXPORT inline void dsAlignedBox3f_addBox(
	dsAlignedBox3f* box, const dsAlignedBox3f* otherBox)
{
	DS_ASSERT(box);
	DS_ASSERT(otherBox);
...
/** @copydoc dsAlignedBox3_addBox() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3d_addBox(
	dsAlignedBox3d* box, const dsAlignedBox3d* otherBox)
{
	DS_ASSERT(box);
	DS_ASSERT(otherBox);
	dsAlignedBox3_addBox(*box, *otherBox);
...
/** @copydoc dsAlignedBox3_addBox() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3i_addBox(
	dsAlignedBox3i* box, const dsAlignedBox3i* otherBox)
{
	DS_ASSERT(box);
	DS_ASSERT(otherBox);
	dsAlignedBox3_addBox(*box, *otherBox);
...
DS_GEOMETRY_EXPORT inline bool dsAlignedBox3f_containsPoint(
...
/** @copydoc dsAlignedBox3_containsPoint() */
DS_GEOMETRY_EXPORT inline bool dsAlignedBox3d_containsPoint(
...
/** @copydoc dsAlignedBox3_containsPoint() */
DS_GEOMETRY_EXPORT inline bool dsAlignedBox3i_containsPoint(
...
DS_GEOMETRY_EXPORT inline bool dsAlignedBox3f_containsBox(
	const dsAlignedBox3f* box, const dsAlignedBox3f* otherBox)
{
	DS_ASSERT(box);
	DS_ASSERT(otherBox);
...
/** @copydoc dsAlignedBox3_containsBox() */
DS_GEOMETRY_EXPORT inline bool dsAlignedBox3d_containsBox(
	const dsAlignedBox3d* box, const dsAlignedBox3d* otherBox)
{
	DS_ASSERT(box);
	DS_ASSERT(otherBox);
	return dsAlignedBox3_containsBox(*box, *otherBox);
...
/** @copydoc dsAlignedBox3_containsBox() */
DS_GEOMETRY_EXPORT inline bool dsAlignedBox3i_containsBox(
	const dsAlignedBox3i* box, const dsAlignedBox3i* otherBox)
{
	DS_ASSERT(box);
	DS_ASSERT(otherBox);
	return dsAlignedBox3_containsBox(*box, *otherBox);
...
DS_GEOMETRY_EXPORT inline bool dsAlignedBox3f_intersects(
	const dsAlignedBox3f* box, const dsAlignedBox3f* otherBox)
{
	DS_ASSERT(box);
	DS_ASSERT(otherBox);
...
/** @copydoc dsAlignedBox3_intersects() */
DS_GEOMETRY_EXPORT inline bool dsAlignedBox3d_intersects(
	const dsAlignedBox3d* box, const dsAlignedBox3d* otherBox)
{
	DS_ASSERT(box);
	DS_ASSERT(otherBox);
...
/** @copydoc dsAlignedBox3_intersects() */
DS_GEOMETRY_EXPORT inline bool dsAlignedBox3i_intersects(
	const dsAlignedBox3i* box, const dsAlignedBox3i* otherBox)
{
	DS_ASSERT(box);
	DS_ASSERT(otherBox);
...
DS_GEOMETRY_EXPORT inline void dsAlignedBox3f_intersect(
	dsAlignedBox3f* result, const dsAlignedBox3f* a, const dsAlignedBox3f* b)
{
	DS_ASSERT(result);
	DS_ASSERT(a);
	DS_ASSERT(b);
...
/** @copydoc dsAlignedBox3_intersect() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3d_intersect(
	dsAlignedBox3d* result, const dsAlignedBox3d* a, const dsAlignedBox3d* b)
{
	DS_ASSERT(result);
	DS_ASSERT(a);
	DS_ASSERT(b);
...
/** @copydoc dsAlignedBox3_intersect() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3i_intersect(
	dsAlignedBox3i* result, const dsAlignedBox3i* a, const dsAlignedBox3i* b)
{
	DS_ASSERT(result);
	DS_ASSERT(a);
	DS_ASSERT(b);
...
DS_GEOMETRY_EXPORT inline void dsAlignedBox3f_toMatrixTranspose(
	dsMatrix44f* result, dsAlignedBox3f* box)
{
	DS_ASSERT(result);
	DS_ASSERT(box);
...
/** @copydoc dsAlignedBox3_toMatrix() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3d_toMatrixTranspose(
	dsMatrix44d* result, dsAlignedBox3d* box)
{
	DS_ASSERT(result);
	DS_ASSERT(box);
	dsAlignedBox3_toMatrixTranspose(*result, *box);
...
DS_GEOMETRY_EXPORT inline void dsAlignedBox3f_corners(
	dsVector3f corners[DS_BOX3_CORNER_COUNT], const dsAlignedBox3f* box)
{
	DS_ASSERT(corners);
	DS_ASSERT(box);
...
/** @copydoc dsAlignedBox3_corners() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3d_corners(
	dsVector3d corners[DS_BOX3_CORNER_COUNT], const dsAlignedBox3d* box)
{
	DS_ASSERT(corners);
	DS_ASSERT(box);
	dsAlignedBox3_corners(corners, *box);
...
/** @copydoc dsAlignedBox3_corners() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3i_corners(
	dsVector3i corners[DS_BOX3_CORNER_COUNT], const dsAlignedBox3i* box)
{
	DS_ASSERT(corners);
	DS_ASSERT(box);
	dsAlignedBox3_corners(corners, *box);
...
DS_GEOMETRY_EXPORT inline void dsAlignedBox3f_closestPoint(
	dsVector3f* result, const dsAlignedBox3f* box, const dsVector3f* point)
{
	DS_ASSERT(result);
	DS_ASSERT(box);
	DS_ASSERT(point);
...
/** @copydoc dsAlignedBox3_closestPoint() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3d_closestPoint(
	dsVector3d* result, const dsAlignedBox3d* box, const dsVector3d* point)
{
	DS_ASSERT(result);
	DS_ASSERT(box);
	DS_ASSERT(point);
...
/** @copydoc dsAlignedBox3_closestPoint() */
DS_GEOMETRY_EXPORT inline void dsAlignedBox3i_closestPoint(
	dsVector3i* result, const dsAlignedBox3i* box, const dsVector3i* point)
{
	DS_ASSERT(result);
	DS_ASSERT(box);
	DS_ASSERT(point);
...
inline void dsAlignedBox3f_makeInvalid(dsAlignedBox3f* result)
{
	DS_ASSERT(result);
...
inline void dsAlignedBox3d_makeInvalid(dsAlignedBox3d* result)
{
	DS_ASSERT(result);
...
inline void dsAlignedBox3i_makeInvalid(dsAlignedBox3i* result)
{
	DS_ASSERT(result);

 ...
 */
DS_PHYSICS_EXPORT const dsPhysicsConstraintType* dsSwingTwistPhysicsConstraint_type(void);
...
DS_PHYSICS_EXPORT void dsSwingTwistPhysicsConstraint_initialize(
	...
	const dsVector3xf* secondPosition, const dsQuaternion4f* secondOrientation, float maxSwingXAngle,

...
inline ::flatbuffers::Offset<RigidBody> CreateRigidBody(
    ...
    DeepSeaPhysics::DOFMask dofMask = DeepSeaPhysics::DOFMask::None,
...
inline bool VerifyRigidBodyBuffer(
  ...
  return verifier.template VerifyBuffer<DeepSeaPhysics::RigidBody>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedRigidBodyBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<DeepSeaPhysics::RigidBody>(nullptr);
}

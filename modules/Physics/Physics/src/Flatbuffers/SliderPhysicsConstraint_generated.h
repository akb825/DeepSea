...
struct SliderConstraintBuilder {
  ...
  void add_firstOrientation(const DeepSeaPhysics::Quaternion4f *firstOrientation) {
    fbb_.AddStruct(SliderConstraint::VT_FIRSTORIENTATION, firstOrientation);
  }
  ...
  void add_secondOrientation(const DeepSeaPhysics::Quaternion4f *secondOrientation) {
    fbb_.AddStruct(SliderConstraint::VT_SECONDORIENTATION, secondOrientation);
  }
  ...
  ::flatbuffers::Offset<SliderConstraint> Finish() {
    ...
    fbb_.Required(o, SliderConstraint::VT_FIRSTORIENTATION);
    fbb_.Required(o, SliderConstraint::VT_SECONDPOSITION);
    fbb_.Required(o, SliderConstraint::VT_SECONDORIENTATION);
    return o;
  }
};

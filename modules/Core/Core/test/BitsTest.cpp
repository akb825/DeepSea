...
{
	EXPECT_FALSE(DS_IS_POWER_OF_2(0));
	EXPECT_TRUE(DS_IS_POWER_OF_2(1));
	EXPECT_TRUE(DS_IS_POWER_OF_2(2));
	EXPECT_FALSE(DS_IS_POWER_OF_2(3));
	EXPECT_TRUE(DS_IS_POWER_OF_2(4));
	EXPECT_FALSE(DS_IS_POWER_OF_2(5));
	EXPECT_FALSE(DS_IS_POWER_OF_2(6));
	EXPECT_FALSE(DS_IS_POWER_OF_2(7));
	EXPECT_TRUE(DS_IS_POWER_OF_2(8));
	EXPECT_FALSE(DS_IS_POWER_OF_2(9));
	EXPECT_FALSE(DS_IS_POWER_OF_2(10));
}
...
TEST(BitsTest, Clz64)
{
	...
	EXPECT_EQ(0U, dsClz64(0xFFFFFFFFFFFFFFF0ULL));
	EXPECT_EQ(0U, dsClz64(0xFFFFFFF000000000ULL));
}
...
TEST(BitsTest, Ctz64)
{
	...
	EXPECT_EQ(4U, dsCtz64(0xFFFFFFFFFFFFFFF0ULL));
	EXPECT_EQ(36U, dsCtz64(0xFFFFFFF000000000ULL));
}

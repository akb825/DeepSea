...
def StandardParticleEmitterFactoryAddRotationSpeedRange(builder, rotationSpeedRange): builder.PrependStructSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(rotationSpeedRange), 0)

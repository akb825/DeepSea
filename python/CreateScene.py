...
from DeepSeaSceneLighting.Convert.LightShadowsPrepareConvert import convertLightShadowsPrepare
...
if __name__ == '__main__':
	...
	convertContext.addGlobalDataType('LightShadowsPrepare', convertLightShadowsPrepare)

...
def LightNodeStart(builder): builder.StartObject(4)
def Start(builder):
...
def LightNodeAddItemLists(builder, itemLists): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(itemLists), 0)

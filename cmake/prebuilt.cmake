...
if (IS_DIRECTORY ${DEEPSEA_PREBUILT_TOOLS_DIR})
	...
	if (DEEPSEA_INSTALL)
		install(DIRECTORY ${DEEPSEA_PREBUILT_TOOLS_DIR}/ DESTINATION tools USE_SOURCE_PERMISSIONS
...
if (NOT DEEPSEA_NO_PREBUILT_LIBS)
	...
	if (DEEPSEA_PREBUILT_LIBS_DIR AND IS_DIRECTORY ${DEEPSEA_PREBUILT_LIBS_DIR})
		...
		if (DEEPSEA_INSTALL)
			install(DIRECTORY ${DEEPSEA_PREBUILT_LIBS_DIR}/ DESTINATION . USE_SOURCE_PERMISSIONS
				PATTERN "version" EXCLUDE)
		endif()
	endif()
endif()

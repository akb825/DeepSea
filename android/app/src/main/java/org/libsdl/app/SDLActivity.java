...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    // Don't pause/resume here:
    // 1. Allows animations to continue when notifications are up.
    // 2. Need to re-create surface when pausing/resuming activity, but will break in Vulkan when
    //    trying to create a surface if the activity wasn't paused. (i.e. if this pauses when losing
    //    focus)
    /*@Override

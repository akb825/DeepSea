...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        // 2. Need to re-create surface when pausing/resuming activity, but will break in Vulkan
        //    when trying to create a surface if the activity wasn't paused. (i.e. if this pauses
        //    when losing focus)
